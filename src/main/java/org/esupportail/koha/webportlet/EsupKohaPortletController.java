...
public class EsupKohaPortletController {
    ...
    @RequestMapping
    public ModelAndView renderView(@RequestParam(value = "renewLoanSuccess", required = false) String renewLoanSuccess, RenderRequest request, RenderResponse response) {	
